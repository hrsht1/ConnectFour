...
public class Connect4Frame extends JFrame
{
     ...
     */
    public Connect4Frame(Connect4Game game, HAgent redPlayer, Agent yellowPlayer)
    {
        super();
        colButton = new JButton[7];
        colButton[0] = new JButton ("Col 1");
        colButton[1] = new JButton ("Col 2");
        colButton[2] = new JButton ("Col 3");
        colButton[3] = new JButton ("Col 4");
        colButton[4] = new JButton ("Col 5");
        colButton[5] = new JButton ("Col 6");
        colButton[6] = new JButton ("Col 7"); 
        
        colButton[0].setText("Col 1"); 
        colButton[1].setText("Col 2"); 
        colButton[2].setText("Col 3"); 
        colButton[3].setText("Col 4"); 
        colButton[4].setText("Col 5"); 
        colButton[5].setText("Col 6"); 
        colButton[6].setText("Col 7"); 
        ...
        colButton[0].setEnabled(true);
        colButton[1].setEnabled(true);
        colButton[2].setEnabled(true); 
        colButton[3].setEnabled(true); 
        colButton[4].setEnabled(true); 
        colButton[5].setEnabled(true); 
        colButton[6].setEnabled(true); 
        
        colButton[0].addActionListener(new ActionListener() {    //connects the play to end button to its buttonPressed method
                public void actionPerformed(ActionEvent e)
                {
                    col0Pressed();
                }
            });
        colButton[1].addActionListener(new ActionListener() {    //connects the play to end button to its buttonPressed method
                public void actionPerformed(ActionEvent e)
                {
                    col1Pressed();
                }
            });
        colButton[2].addActionListener(new ActionListener() {    //connects the play to end button to its buttonPressed method
                public void actionPerformed(ActionEvent e)
                {
                    col2Pressed();
                }
            });
        colButton[3].addActionListener(new ActionListener() {    //connects the play to end button to its buttonPressed method
                public void actionPerformed(ActionEvent e)
                {
                    col3Pressed();
                }
            });
        colButton[4].addActionListener(new ActionListener() {    //connects the play to end button to its buttonPressed method
                public void actionPerformed(ActionEvent e)
                {
                    col4Pressed();
                }
            });
        colButton[5].addActionListener(new ActionListener() {    //connects the play to end button to its buttonPressed method
                public void actionPerformed(ActionEvent e)
                {
                    col5Pressed();
                }
            });
        colButton[6].addActionListener(new ActionListener() {    //connects the play to end button to its buttonPressed method
                public void actionPerformed(ActionEvent e)
                {
                    col6Pressed();
                }
            });
        JPanel buttonPaneCol = new JPanel();   // creates a pane for the cols
        buttonPaneCol.setLayout(new BoxLayout(buttonPaneCol, BoxLayout.X_AXIS)); 
       ...
       /* buttonPane.add(Box.createRigidArea(new Dimension(10,0)));
        ...
        buttonPaneCol.add(Box.createHorizontalGlue());
        buttonPaneCol.add(Box.createRigidArea(new Dimension(-9,0)));
        buttonPaneCol.add(colButton[0]);
        buttonPaneCol.add(Box.createRigidArea(new Dimension(25,0)));
        buttonPaneCol.add(colButton[1]);
        buttonPaneCol.add(Box.createRigidArea(new Dimension(25,0)));
        buttonPaneCol.add(colButton[2]);
        buttonPaneCol.add(Box.createRigidArea(new Dimension(25,0)));
        buttonPaneCol.add(colButton[3]);
        buttonPaneCol.add(Box.createRigidArea(new Dimension(25,0)));
        buttonPaneCol.add(colButton[4]);
        buttonPaneCol.add(Box.createRigidArea(new Dimension(25,0)));
        buttonPaneCol.add(colButton[5]);
        buttonPaneCol.add(Box.createRigidArea(new Dimension(25,0)));
        buttonPaneCol.add(colButton[6]); 
        buttonPaneCol.add(Box.createHorizontalGlue());
    ...
    */
    ...
    public void newGame()
    {
        ...
        enableButtons();
        gameActive = true;
        //redPlayerturn = false; //Remove as comment if you want red to always play first
        redPlayerturn = r.nextBoolean(); // Remove as comment if you want a random choice for first player!
        if (redPlayerturn)
        {
    ...
    private void disableButtons()
    {
        ...
        colButton[0].setEnabled(false);
        colButton[1].setEnabled(false);
        colButton[2].setEnabled(false); 
        colButton[3].setEnabled(false); 
        colButton[4].setEnabled(false); 
        colButton[5].setEnabled(false); 
        colButton[6].setEnabled(false); 
    }
    ...
    /**
     * Action performed on Clicking Button 1 [0]
     */
    public void col0Pressed()
    {
        colPressed(0);
    }
    /**
     * Action performed on Clicking Button 2 [1]
     */
    ...
    /**
     * Action performed on Clicking Button 3 [2]
     */
    ...
    /**
     * Action performed on Clicking Button 4 [3]
     */
    ...
    /**
     * Action performed on Clicking Button 5 [4]
     */
    ...
    /**
     * Action performed on Clicking Button 6 [5]
     */
    ...
    /**
     * Action performed on Clicking Button 7 [6]
     */
    ...
    /**
     * Placing the coin depending upon the column pressed
     * 
     * @param x the coloumn on which the coin to be placed
     */
    public void colPressed(int x)
    {
        Connect4Game oldBoard = new Connect4Game(myGame);   // store the old board for validation
        int colToDisable = -10;
        if(redPlayerturn) // if it's the red player's turn, run their move
        {
            colToDisable = redPlayer.move(x);
            if(colToDisable>=0)
            {
                colButton[colToDisable].setEnabled(false);
            }
            for(int i = 0;i<7;i++)
            {
                if(getLowestEmptyIndex(myGame.getColumn(i)) == -1)
                {
                    colButton[i].setEnabled(false);
                }
            }
            alert(yellowPlayer.toString() + " plays next...");
            char won1 = myGame.gameWon();
            if(won1 == 'N' && !myGame.boardFull())
            {
            yellowPlayer.move();
            for(int i = 0;i<7;i++)
            {
