...
public abstract class HAgent
{
     ...
     */
    public HAgent(Connect4Game game, boolean iAmRed)
    {
        this.myGame = game;
        this.iAmRed = iAmRed;
    }
     ...
     */
    public abstract int move(int i);
    /**
    ...
    /*public abstract void getFrame(Connect4Frame frame);
    public abstract int getLowestEmptyIndex(Connect4Column column);
    public abstract JButton[] getCB();
    public abstract void intializeButtonPressed();
